...
extern int GQuadLayerMismatch37; /* penalty per incompatible gquad layer in a sub-alignment (applied
                                    twice for inner layers) */
extern int GQuadLayerMismatchH;
extern int GQuadLayerMismatchMax; /* maximum number of mismatching sequences in the alignment when
